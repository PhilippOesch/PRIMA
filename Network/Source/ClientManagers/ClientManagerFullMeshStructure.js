System.register(["../ModuleCollector"], function (exports_1, context_1) {
    "use strict";
    var FudgeNetwork, ClientManagerFullMeshStructure;
    ...
    return {
        ...
        execute: function () {
            ClientManagerFullMeshStructure = class ClientManagerFullMeshStructure {
                constructor() {
            ...
            exports_1("ClientManagerFullMeshStructure", ClientManagerFullMeshStructure);
        }
    };
});
//# sourceMappingURL=ClientManagerFullMeshStructure.js.map