System.register(["../ModuleCollector"], function (exports_1, context_1) {
    "use strict";
    var FudgeNetwork, ClientManagerWebSocketOnly;
    ...
    return {
        ...
        execute: function () {
            ClientManagerWebSocketOnly = class ClientManagerWebSocketOnly {
                constructor() {
            ...
            exports_1("ClientManagerWebSocketOnly", ClientManagerWebSocketOnly);
        }
    };
});
//# sourceMappingURL=ClientManagerPureWebSocket.js.map