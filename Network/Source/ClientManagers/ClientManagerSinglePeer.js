System.register(["../ModuleCollector"], function (exports_1, context_1) {
    "use strict";
    var FudgeNetwork, ClientManagerSinglePeer;
    ...
    return {
        ...
        execute: function () {
            ClientManagerSinglePeer = class ClientManagerSinglePeer {
                constructor() {
            ...
            exports_1("ClientManagerSinglePeer", ClientManagerSinglePeer);
        }
    };
});
//# sourceMappingURL=ClientManagerSinglePeer.js.map