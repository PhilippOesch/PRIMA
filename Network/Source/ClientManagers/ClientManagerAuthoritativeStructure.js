System.register(["../ModuleCollector"], function (exports_1, context_1) {
    "use strict";
    var FudgeNetwork, ClientManagerAuthoritativeStructure;
    ...
    return {
        ...
        execute: function () {
            ClientManagerAuthoritativeStructure = class ClientManagerAuthoritativeStructure {
                constructor() {
                    ...
                    this.sendDisconnectRequest = () => {
                        try {
                            let dcRequest = new FudgeNetwork.PeerMessageDisconnectClient(this.localClientID);
                    ...
                    this.sendKeyPress = (_keyCode) => {
                        try {
                            if (this.remoteEventPeerDataChannel != undefined) {
                                let keyPressMessage = new FudgeNetwork.PeerMessageKeysInput(this.localClientID, _keyCode);
            ...
            exports_1("ClientManagerAuthoritativeStructure", ClientManagerAuthoritativeStructure);
        }
    };
});
//# sourceMappingURL=ClientManagerAuthoritativeStructure.js.map