System.register(["ws", "../ModuleCollector"], function (exports_1, context_1) {
    "use strict";
    var ws_1, FudgeNetwork, FudgeServerMeshNetwork;
    ...
    return {
        ...
        execute: function () {
            FudgeServerMeshNetwork = class FudgeServerMeshNetwork {
                constructor() {
            ...
            exports_1("FudgeServerMeshNetwork", FudgeServerMeshNetwork);
        }
    };
});
//# sourceMappingURL=FudgeServerMeshNetwork.js.map