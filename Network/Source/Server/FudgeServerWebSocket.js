System.register(["ws", "../ModuleCollector", "../DataHandling"], function (exports_1, context_1) {
    "use strict";
    var ws_1, FudgeNetwork, DataHandling_1, FudgeServerWebSocket;
    ...
    return {
        setters: [
            ...
            function (DataHandling_1_1) {
                DataHandling_1 = DataHandling_1_1;
            }
        ],
        execute: function () {
            FudgeServerWebSocket = class FudgeServerWebSocket {
                constructor() {
            ...
            exports_1("FudgeServerWebSocket", FudgeServerWebSocket);
        }
    };
});
//# sourceMappingURL=FudgeServerWebSocket.js.map