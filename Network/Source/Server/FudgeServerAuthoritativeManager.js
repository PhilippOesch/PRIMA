System.register(["../ModuleCollector"], function (exports_1, context_1) {
    "use strict";
    var FudgeNetwork, FudgeServerAuthoritativeManager;
    ...
    return {
        ...
        execute: function () {
            FudgeServerAuthoritativeManager = class FudgeServerAuthoritativeManager {
                constructor() {
            ...
            exports_1("FudgeServerAuthoritativeManager", FudgeServerAuthoritativeManager);
        }
    };
});
//# sourceMappingURL=FudgeServerAuthoritativeManager.js.map